...
import "./WithdrawWalletHistory.css";

const WithdrawWalletHistory = () => {
  ...
  const handleSearch = () => {
    ...
    // Example API call can go here:
    // fetch(`/api/withdraw-history?from=${fromDate}&to=${toDate}`)
  };
  ...
  return (
    <div className="withdraw-history-container">
      ...
      <div className="table-card">
        <h3 className="section-title">Withdraw Wallet History</h3>
...
export default WithdrawWalletHistory;
